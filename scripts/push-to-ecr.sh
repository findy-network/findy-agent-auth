...
echo "Releasing findy-agent-auth version $VERSION"
...
docker tag findy-agent-auth:latest $FULL_NAME:$VERSION
docker tag findy-agent-auth:latest $FULL_NAME:latest
